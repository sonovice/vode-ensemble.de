...
const concerts: Record<string, ConcertEntry[]> = {
  "2025": [
    ...
    },
    {
      ...
      location: "Bielefeld",
      address:
        "Altstädter Nikolaikirche | Altstädter Kirchplatz 1 | 33602 Bielefeld",
      ...
      description: (
        <>
          <span class="text-xs italic">
            Wir danken der{" "}
            <a
              href="https://www.bielefelder-buergerstiftung.de/"
              target="_blank"
              rel="noopener noreferrer"
              class="text-[var(--color-accent)] hover:underline"
            >
            ...
            für die finanzielle Unterstützung des Konzerts.
          </span>
        </>
      ),
    },
...
const Konzerte: Component = () => {
  ...
  const yearConcerts = createMemo(() => {
    ...
    const allConcertsInYear = concerts[selected].sort(
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="flex flex-col md:flex-row items-start gap-10 lg:gap-16">
          <div class="w-full">
            ...
            <h2 class="text-3xl font-semibold mt-12 mb-6 text-left text-[var(--color-light-text)]">
              {t("concerts.pastTitle", {}, "Vergangene Konzerte")}
            </h2>
