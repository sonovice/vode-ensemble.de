...
const de: BaseDictionary = {
	...
	academyPage: {
		...
		philosophyP1: "Singen ist für uns mehr als Kunst – es ist Haltung. In einer Gruppe zu musizieren bedeutet, auf sich selbst zu hören und der eigenen Stimme Raum zu geben, aber genauso auf die anderen Stimmen Acht zu geben. Das ist es, was am Ende zu einem harmonischen Miteinander führt – auf der Bühne wie im Leben.",
		philosophyP2: "Bei <em>vode</em> bringen rund 20 Musiker:innen ganz unterschiedliche Kompetenzen zusammen: Vocal Coaching, Schulpädagogik, Tontechnik, Arrangement und Komposition. Aus dieser Vielfalt ist eine besondere Probenkultur entstanden, in der jede:r Einzelne das Gesamtergebnis mitgestaltet. Dieses Prinzip – dass es auf jede einzelne Stimme ankommt – wollen wir auch über unser Ensemble hinaus weitergeben.",
		philosophyP3: "Wer einmal erlebt hat, wie es sich anfühlt, Teil einer Gruppe zu sein und gleichzeitig die eigene Stimme zu entdecken, möchte dieses Gefühl immer wieder haben. Genau solche Erfahrungen wollen wir ermöglichen: Momente, in denen Musik nicht nur gehört, sondern am ganzen Körper gespürt wird – und in denen aus vielen einzelnen Stimmen etwas Gemeinsames entsteht.",
