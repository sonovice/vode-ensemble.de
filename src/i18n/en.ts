...
const en: BaseDictionary = {
	...
	academy: {
		...
		audioSubtitlePreLink: 'From the podcast ',
	...
	academyPage: {
		sectionTag: "Education",
		title: "vode academy",
		heroIntro: "Musical excellence meets educational vision: The <em>vode academy</em> brings together the diverse expertise of our ensemble in coaching and workshop formats that we share with choirs, schools, and institutions.",
		philosophyTag: "Philosophy",
		philosophyTitle: "Why we do this",
		philosophyP1: "For us, singing is more than art – it's an attitude. Making music in a group means listening to yourself and giving your own voice space, but equally paying attention to the other voices. That's what ultimately leads to a harmonious togetherness – on stage and in life.",
		philosophyP2: "At <em>vode</em>, around 20 musicians bring together a wide range of expertise: vocal coaching, music education, sound engineering, arranging, and composition. From this diversity, a unique rehearsal culture has emerged where every individual shapes the collective result. This principle – that every single voice matters – is what we want to pass on beyond our own ensemble.",
		philosophyP3: "Once you've experienced what it feels like to be part of a group while discovering your own voice, you want that feeling again and again. These are exactly the kinds of experiences we want to create: moments where music isn't just heard but felt throughout the whole body – and where many individual voices come together to create something shared.",
		pullQuote: "They sing in multiple voices and they think in multiple dimensions. A vocal ensemble that combines musical excellence with an educational mission.",
		pullQuoteSource: "Deutschlandfunk Kultur, Choir of the Week",
		formatsTag: "Formats",
		formatsTitle: "What we offer",
		formatsIntro: "We have developed various workshop and coaching formats tailored to different target groups and needs – from individual vocal work to multi-day intensive projects.",
		expertDescription: "In <em>vode:expert</em>, individual members of the ensemble pass on their specialist knowledge and offer topic-specific coaching sessions that delve deep into musical or technical topics. The content ranges from groove and timing to breathing and body work to practical aspects of miking and sound reinforcement for live performances or recordings. The aim is to make individual know-how from the ensemble accessible and to offer concrete impulses for vocal and musical development.",
		collectiveDescription: "<em>vode:collective</em> is a workshop format that focuses on collective learning, mutual coaching, and creative self-responsibility. Several people from one voice group independently develop sound concepts and practice dealing with specific challenges. <em>vode</em> members also provide vocal coaching, which enriches the work not only musically but also vocally. The choir director then coordinates the various approaches into a unified musical concept. This format strengthens individual responsibility, the creative potential of each voice group, and promotes a cooperative, equitable environment in the musical design process.",
		workshopDayTitle: "vode:intensiv",
		workshopDayDescription: "In <em>vode:intensiv</em>, participants come together for one or more days to make music intensively under the guidance of <em>vode</em> members. The format is aimed at young people, choir singers, or mixed groups and includes repertoire work, creative workshops, and a joint closing concert. We combine professional coaching with a community experience that goes beyond singing itself – as in our <a href=\"/academy-2025\" class=\"text-[var(--color-accent)] hover:underline\">vode academy 2025</a>.",
		tagCoaching: "Coaching",
		tagIndividual: "Individual",
		tagWorkshop: "Workshop",
		tagGroup: "Group",
		tagIntensive: "Intensive",
		tagProject: "Project",
		approachTag: "Our approach",
		approachTitle: "Who we're here for",
		approachP1: "Our offerings are designed for anyone who sees singing as more than just a hobby: choirs looking for fresh inspiration in their rehearsal work, schools wanting to enrich their music education, and young people who want to discover or deepen their experience of making music together.",
		approachP2: "We are convinced that music education – and singing in particular – deserves a much greater role. Once you've experienced what it feels like to be part of a group and discover your own voice at the same time, you want that feeling again and again. That's why we need more of these opportunities – and that's exactly what drives us.",
		materialTag: "Material",
		materialTitle: "Material & Tutorials",
		materialIntro: "Here you'll find tutorials and sheet music from our projects to sing along and practice.",
		ctaTitle: "Interested?",
		ctaText: "Whether for your choir, your school, or a special project – we're happy to develop a format that fits your needs. Get in touch and let's figure out how we can work together.",
