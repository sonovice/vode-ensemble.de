...
const en: BaseDictionary = {
	...
	academyPage: {
		...
		philosophyP1: "For us, music is created in a spirit of collaboration. To make our concerts special, we bring to our rehearsals what each of us does best: Some members of <em>vode</em> work as vocal coaches, helping to realize musical ideas vocally. Others teach at schools and develop innovative rehearsal formats for groups. Still others work as sound engineers and have a fine sense for sound and details.",
		philosophyP2: "These diverse experiences and strengths flow into our joint rehearsal work – and we all benefit from it. We have experienced how rewarding it is to advance music together as an entire ensemble. And we decided: this is an experience we want to share with others.",
		philosophyP3: "Choral singing benefits society because you have to listen to yourself and give your own voice enough space – but you also have to pay attention to the other voices, in order to achieve a harmonious coexistence. Every individual voice needs to be heard. For that, I also need to open my ears and develop a sense for the whole group. That's exactly what we want to pass on.",
